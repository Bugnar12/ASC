...
;_asm_module : - parameters : the number that is given from C from the array
;              - the module divides the number 3 times and gets in edx the remainder
;              - the remainder from edx is transferred to eax and returned 
